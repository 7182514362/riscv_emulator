...
#ifndef YY_YY_EXPRPARSER_H_INCLUDED
# define YY_YY_EXPRPARSER_H_INCLUDED
// "%code requires" blocks.
#line 10 "expr_parser.yy"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // HEX_NUMBER
      // expr
      char dummy2[sizeof (unsigned int)];
    };
    ...
    TOK_SPACE = 14,                // SPACE
    TOK_END = 15,                  // END
    TOK_REGISTER = 16,             // REGISTER
    TOK_NUMBER = 17,               // NUMBER
    TOK_HEX_NUMBER = 18            // HEX_NUMBER
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_SPACE = 14,                            // SPACE
        S_END = 15,                              // END
        S_REGISTER = 16,                         // REGISTER
        S_NUMBER = 17,                           // NUMBER
        S_HEX_NUMBER = 18,                       // HEX_NUMBER
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT (tok == token::TOK_REGISTER);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::TOK_NUMBER <= tok && tok <= token::TOK_HEX_NUMBER));
#endif
      }
    };

    /// Build a parser object.
    parser (remu::Expr& exp_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOK_SPACE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_SPACE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_NUMBER (unsigned int v, location_type l)
      {
      ...
      static
      symbol_type
      make_HEX_NUMBER (unsigned int v, location_type l)
      {
        return symbol_type (token::TOK_HEX_NUMBER, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_HEX_NUMBER (const unsigned int& v, const location_type& l)
      {
...
#line 1607 "ExprParser.h"




#endif // !YY_YY_EXPRPARSER_H_INCLUDED
